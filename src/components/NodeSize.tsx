...
const Slider: React.FC = () => {
    ...
    return (
        <div className="relative lg:w-60 md:w-40 sm:w-48 xs:hidden mb-6 mx-3">
            ...
            <input id="labels-range-input" tabIndex={0} type="range" min="36" max="66" value={size} step="10" onChange={(e) => handleSliderChange(e)} className="w-full h-2 mb-1 range-sm text-blue-900 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200" />
